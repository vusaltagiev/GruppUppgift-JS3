...
exports.getAllProducts = (req,res) => {
    ...
    Product.find()
     ...
     .catch(() => res.status(500).json({message: 'Could not retrieve products'}))
}
...
exports.addProduct = (req,res) => {
    ...
    Product.create({ name, price, image, image2, image3, image4, category, description})
...
exports.updateProduct = (req, res) => {
    ...
    Product.updateOne({_id: req.params.id }, {$set: { name, price, image, category, image2,image3,image4 }})
     .then(() => {
